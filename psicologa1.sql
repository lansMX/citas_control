...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-10-2017 a las 05:50:11
...
INSERT INTO `tab_usuarios` (`idTab_Usuario`, `Nombre`, `Usuario`, `Password`, `Apellidos`, `Telefono`, `Email`, `Direccion`, `Telefono2`, `idTipoUsuario`, `Foto`) VALUES
(1, 'Arturo Navarrete', 'lans', 'aserty', '', '', '', '', '', 1, '/img/perfil.jpg');
...
--
ALTER TABLE `tab_usuarios`
  MODIFY `idTab_Usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
